...
then
	...
	then
		...
		export KBUILD_BUILD_HOST="FyyyyK"
...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	echo " "
		msg "|| Cloning GCC 10.2.1 baremetal ||"
	...
	git clone --depth 1 --no-single-branch https://github.com/BENKz29/AnyKernel3 -b master
	sed -i "s/kernel.string=.*/kernel.string=$ZIPNAME by @FyyyyK/g" AnyKernel3/anykernel.sh
}

##------------------------------------------------------##

exports() {
	export KBUILD_BUILD_USER="26b851d"
	export ARCH=arm64
...
build_kernel() {
	...
	export CROSS_COMPILE_ARM32=$GCC32_DIR/bin/arm-none-linux-gnueabihf-
